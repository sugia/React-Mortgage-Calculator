...
function InputRow(props) {
    ...
    return (
        <Space.Compact>
            <Button style={{'width': '125px', 'cursor': 'pointer', 'backgroundColor': 'AliceBlue'}} onClick={() => {
            ...
            <Popup position='bottom' visible={isDescriptionVisible} showCloseButton
                onClose={() => {
                ...
                closeOnSwipe={true}
            >
                <Row style={{'margin': '4px 16px'}}>
                    <Typography style={{'fontSize': '20px'}}>{name}</Typography>
                </Row>
                <Divider style={{'margin': '0px'}} />

                <Row style={{'margin': '4px 16px 16px 16px'}}>
...
function InputRowCalendar(props) {
    ...
    return (
        <Space.Compact>
            <Button style={{'width': '126px', 'cursor': 'pointer', 'backgroundColor': 'AliceBlue'}} onClick={() => {
                setIsDescriptionVisible(true)
            }}>
                <Row style={{'width': '100%'}} justify='start'>
                    {name}
            ...
            <DatePicker
                ...
                min={value.add(-500, 'year').toDate()}
                max={value.add(500, 'year').toDate()}
            >

            </DatePicker>
            <Button style={{'width': '174px'}} onClick={() => {
                setIsDatePickerVisible(true)
            }}>
                <Row style={{'width': '100%', 'marginLeft': '-4px'}} justify='start'>
                    {value.format('YYYY-MM')}
                </Row>
                <Row style={{'width': '49px'}} justify='end'>
                    <CalendarOutline style={{'color': 'gray'}} />
                </Row>
            </Button>
